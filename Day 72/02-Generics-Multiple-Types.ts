...
function returnTypeEx<T>(val: T): T {
 ...
 console.log(returnTypeEx<string>("Arsalan")); // Returns: "Arsalan" (string)
 ...
 function testType<T>(val: T): string {
   return `The Name Is ${val} And Type Is ${typeof val}`;
 }
 
 console.log(testType<number>(100));
 // Returns: "The Value Is 100 And Type Is number"
 
 console.log(testType<string>("Arsalan"));
 // Returns: "The Value Is Arsalan And Type Is string"
